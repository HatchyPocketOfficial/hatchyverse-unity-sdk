...
namespace HatchyverseAPI.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Pick_Asset.Exclude_keyofAsset.uid__")]
    public partial class PickAssetExcludeKeyofAssetUid
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PickAssetExcludeKeyofAssetUid" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PickAssetExcludeKeyofAssetUid() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PickAssetExcludeKeyofAssetUid" /> class.
        /// </summary>
        ...
        public PickAssetExcludeKeyofAssetUid(string name = default(string), string category = default(string), string description = default(string), string contract = default(string), string holder = default(string), ContractTypeEnum? contractType = default(ContractTypeEnum?), string tokenId = default(string), TypeEnum? type = default(TypeEnum?), string property = default(string), string image = default(string))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for PickAssetExcludeKeyofAssetUid and cannot be null");
            }
            this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PickAssetExcludeKeyofAssetUid {\n");
