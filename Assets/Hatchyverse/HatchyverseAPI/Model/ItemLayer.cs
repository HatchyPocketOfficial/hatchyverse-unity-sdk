...
namespace HatchyverseAPI.Model
{
    ...
    /// ItemLayer
    /// </summary>
    [DataContract(Name = "ItemLayer")]
    public partial class ItemLayer
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemLayer" /> class.
        /// </summary>
        ...
        public ItemLayer(double id = default(double), string name = default(string), double order = default(double), string layer = default(string), ItemType type = default(ItemType))
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for ItemLayer and cannot be null");
            }
            this.Name = name;
            this.Order = order;
