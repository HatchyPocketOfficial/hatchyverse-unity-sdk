...
namespace HatchyverseAPI.Model
{
    ...
    public partial class VoucherClaimSignature
    {
        ...
        public VoucherClaimSignature(double rewardContractType = default(double), string rewardHolderAddress = default(string), string rewardContract = default(string), string receiver = default(string), double? amount = default(double?), double claimableUntil = default(double), string voucherId = default(string), string signature = default(string), string tokenId = default(string), double eggType = default(double))
        {
